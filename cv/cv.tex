...
\begin{minipage}[t]{0.72\textwidth}
    ...
    \begin{itemize}[leftmargin=1.5em, nosep]
        \coreskills{Management, DevRel, C++, C\#, Vulkan, Python}
        ...
        \item Extensively used Python to automate and accelerate workflows.
    ...
    \begin{itemize}[leftmargin=1.5em, nosep]
        \coreskills{C, C++, Perl, Python, Lua, DirectX, OpenGL}
        \item Ported high-profile Windows C++ video games to macOS, Linux, and Android.
        \item Developed tools, scripts and debugger bindings in Python.
